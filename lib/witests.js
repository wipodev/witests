import { diff, normalizeString, deepEqual } from "./utils.js";
          ...
          if (isErrorTest) {
            ...
            if (typeof result === "object") {
              if (deepEqual(result, expected)) {
                ...
                const serializedExpected = JSON.stringify(expected, null, 2);
                console.log(diff(serializedExpected, serializedResult, { head: `Test ${name} failed!` }));
                failed++;
              }
            } else {
